...
if __name__ == '__main__':
    ...
    ********************************************************************
    ...
    parser.add_argument('--nnet_type',    type=str,   default='resnet',           help='Network architectures: sngan and resnet')
    ...
    parser.add_argument('--data_source',  type=str,   default='./data/stl10/',    help='The dataset path to store (if data is unavailable, it is downloaded automatically)')
    ...
    ********************************************************************
    ...
    '''
    network architecture supports: 'sngan', 'resnet' 
    '''
    ...
    if nnet_type == 'sngan':
        ...
        if ss_task == 1:
           ...
           lambda_g = 0.01 # 0.01 for MS
        else:
           lambda_d = 0.0  
           lambda_g = 0.0       
    else:
        print('[msdistgan_stl10.py -- __main__] nnet_type = %s is not supported.' % (nnet_type))
        exit()	
