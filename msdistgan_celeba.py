...
if __name__ == '__main__':
    ...
    ********************************************************************
    ...
    parser.add_argument('--data_source',  type=str,   default='./data/celeba/', help='The dataset path to store (if data is unavailable, it is downloaded automatically)')
    ...
    ********************************************************************
    ...
    data_source = '/media/mangroup/Elements/SUTD/Data/celeba/'
    ...
    ********************************************************************
    ...
    if nnet_type == 'dcgan':    
       ...
       print('\n[msdisgan_celeba.py -- __main__] %s is not supported.' % (nnet_type))
       exit() 
    '''
    ********************************************************************
